...
// import { MsgCreateDenom, MsgExecuteContract } from "@injectivelabs/sdk-ts";
...
// const createCw20 = async (formData:FormData) => {
    
//     let getData = MsgCreateDenom.fromJSON({
//         sender: wallet?.account?.address,
//         subdenom: formData.collectionName,
//     })
//     try {
...
// }
// const createCandy = async (exchange:string,formData:FormData) =>{
// if(wallet){
//     console.log(pathname)
//   const claimMessage = constructCandyMessage(
//         wallet?.account?.address,
//         exchange, // actually cw721 but shhhhhhh
//         {
...
//         createCollectionExchange(formData) 
//     }else{
...
//                                 Create a new collection to start selling your NFTs 
//                             </h5>
//                         </div>
